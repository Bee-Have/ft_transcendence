...
function Card({ user, onClick }: CardProps) {
  return (
    <div className="card" onClick={(event) => onClick(user, event)}>
      <div className="PP">
...
const FriendList: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setFriends([
      ...
      { id: 2, username: "123456789", status: "offline", photo: PHOTO_FETCH_URL + 2 },
      { id: 3, username: "123456789abcdef", status: "online", photo: PHOTO_FETCH_URL + 3 },
      { id: 4, username: "pasteque", status: "offline", photo: PHOTO_FETCH_URL + 4 },
      { id: 5, username: "test5", status: "playing", photo: PHOTO_FETCH_URL + 5 },
    ]);
  }, []);
